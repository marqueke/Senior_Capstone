...
class SweepIV_Window:
    def __init__(self, root):
        self.root = root
        self.root.title("Sample Bias Sweep Parameters")
        self.root.config(bg="#d3d3d3")
        self.root.geometry("475x175")
        
        # Initialize the widgets
        self.init_iv_sweep_widgets()
    
    def init_iv_sweep_widgets(self):
        # min voltage
    ...
    def publish_iv_sweep_widgets(self):
        # start voltage
